...
- **Injecting simulated galaxies in real photometric images**: literature review of injection simulations, which are critical for accurately characterizing the image analysis pipelines that measure the properties of millions of galaxies (for testing models of cosmology and galaxy formation). This would cover how the synthetic galaxies are simulated (morphology, colors, morphology, etc), how they are injected in photometric images (real or also synthetic), how properties of interest are measured and how they compare to the original inputs. This would include reviewing and playing with one or multiple codes to perform some injections and extractions (for example the public DECALS or LSST pipelines). 
